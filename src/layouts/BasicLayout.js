...
function formatter(data, parentPath = '', parentAuthority, parentName) {
  return data
    .map(item => {
      console.log('从route.config.js中解析菜单：', item);
      let locale = 'menu';
      ...
      if (item.path) {
        ...
        console.log('result删除routes后:', result);
        return result;
      }
      return null;
    })
...
class BasicLayout extends React.PureComponent {
  ...
  componentDidMount() {
    //console.log('菜单数据格式是： ', this.state.menuData);
    const { dispatch } = this.props;
    console.log('BasicLayout开始执行。。。');
    dispatch({
  ...
  getMenuData() {
    ...
    console.log('props属性是：', this.props);
  ...
  getBreadcrumbNameMap() {
    ...
    // const { menuTree } = this.props;
    // console.log("getBreadcrumbNameMap menuTree:", menuTree);
    // const { menuData } = menuTree;
    // console.log('getBreadcrumbNameMap menuData: ', menuData);
    // const { menuList } = memoizeOneFormatter(menuData)
    // console.log('getBreadcrumbNameMap menuList: ', menuList);
    mergeMenuAndRouter(this.getMenuData());
    // mergeMenuAndRouter(this.state.menuList);
    // console.log("getBreadcrumbNameMap: routerMap: ", routerMap);
    return routerMap;
  }
  ...
  matchParamsPath = pathname => {
    ...
    console.log('matchParamsPath pathKey: ', pathKey);
    console.log('matchParamsPath breadcrumbNameMap: ', this.breadcrumbNameMap);
